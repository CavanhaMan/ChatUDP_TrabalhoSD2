...
public class Chat extends javax.swing.JFrame   implements ActionListener, KeyListener {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(campoEntraNome, javax.swing.GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE)
    ...
    private void btEnviarMsgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEnviarMsgActionPerformed
        //bfw.write(telaChat.append("\r\n"));
        telaChat.append("\r\n");
        telaChat.append( nome + " diz -> " + campoEntraMsg.getText()+"\r\n");
